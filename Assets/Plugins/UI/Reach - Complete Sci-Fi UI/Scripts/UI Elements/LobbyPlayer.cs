...
namespace Michsky.UI.Reach
{
    public class LobbyPlayer : MonoBehaviour
    {
        ...
        [SerializeField] private RawImage pictureReadyImg;
        [SerializeField] private RawImage pictureNotReadyImg;
        ...
        void OnEnable()
        {
            ...
            if (pictureReadyImg.texture != playerPicture) { SetPlayerPicture(playerPicture); }
        ...
        public void SetPlayerPicture(Texture2D pic)
        {
            playerPicture = pic;

            if (pictureReadyImg != null) { pictureReadyImg.texture = playerPicture; }
            if (pictureNotReadyImg != null) { pictureNotReadyImg.texture = playerPicture; }
        }
