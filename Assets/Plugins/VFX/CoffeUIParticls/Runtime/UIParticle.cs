            ...
            get
            {
                ...
                for (int i = 0; i < particles.Count; i++)
                {
                    if (particles[i] != null)
                    {
                        ...
                        if (mainModule.loop)
                        {
                            // For looping particles, use lifetime or a reasonable estimate
                            particleDuration = mainModule.startLifetime.constantMax;
                        }
        ...
        public float startLifetime
        {
            get
            {
                ...
                for (int i = 0; i < particles.Count; i++)
                {
                    ...
                    {
                        var mainModule = particles[i].main;
                        float lifetime = mainModule.startLifetime.constantMax;
