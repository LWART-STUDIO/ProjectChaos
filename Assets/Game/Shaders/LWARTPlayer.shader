	...
	SubShader
	{
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float4 __bsmcDiffuseSample = TCP2_TEX2D_SAMPLE(_Diffuse,_Diffuse,input.pack0.xy).rgba; 
			...
			//	float4 bsmcDiffuseSample = TCP2_TEX2D_SAMPLE(_Diffuse,_Diffuse,uv); // Используем _Diffuse и соответствующий сэмплер
				...
				half3 finalSkinColor = lerp(__bsmcDiffuseSample.rgb, _SkinTone.rgb, _SkinTone.a);
				...
				color*= finalSkinColorWithUnderTone; // Заменяем Albedo на рассчитанный из BSMC
...
/* TCP_DATA u config(ver:"2.9.10";unity:"6000.0.58f2";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","WRAPPED_LIGHTING_HALF","ENABLE_DEPTH_NORMALS_PASS","DIFFUSE_TINT_MASK","OUTLINE_URP_FEATURE","OUTLINE_CLIP_SPACE","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[injectedFile(guid:"fc7daa7b759a2fa4786f2ccaae4058e9";filename:"BSMC_Skin_Injection";injectedPoints:list[injectedPoint(name:"Properties/Start";enabled:True;replace:False;displayName:__NULL__;blockName:"BSMC Skin Properties";program:Undefined;shaderProperties:list[]),injectedPoint(name:"Variables/Inside CBuffer";enabled:True;replace:False;displayName:__NULL__;blockName:"BSMC Skin Variables";program:Undefined;shaderProperties:list[]),injectedPoint(name:"Functions";enabled:True;replace:False;displayName:__NULL__;blockName:"BSMC Skin Functions";program:Undefined;shaderProperties:list[]),injectedPoint(name:"Main Pass/Fragment Shader/End";enabled:True;replace:False;displayName:__NULL__;blockName:"BSMC Skin Fragment Logic";program:Fragment;shaderProperties:list[]),injectedPoint(name:"Main Pass/Fragment Shader/Start";enabled:True;replace:False;displayName:__NULL__;blockName:"BSMC Skin Textures Declaration";program:Fragment;shaderProperties:list[])])];mark:False);matLayers:list[]) */
/* TCP_HASH 1e78f2f177a6e96f4ecfdb2a38708f75 */
