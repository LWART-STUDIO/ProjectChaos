...
namespace Sisus.Init
{
	...
	public abstract class CustomInitializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
		: Initializer<TClient>, IInitializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
	{
		...
		protected override bool HasNullArguments => IsNull(this, firstArgument) || IsNull(this, secondArgument) || IsNull(this, thirdArgument)
												 || IsNull(this, fourthArgument) || IsNull(this, fifthArgument);

		protected sealed override void InitTarget(TClient target) => InitTarget(target, firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument);
		...
		[NotNull]
		protected abstract void InitTarget(TClient target, TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument, TFourthArgument fourthArgument, TFifthArgument fifthArgument);

		#if UNITY_EDITOR
		private protected sealed override void Reset()
		{
			AutoInitUtility.PrepareArgumentsForAutoInit<TClient>(this, 5);
