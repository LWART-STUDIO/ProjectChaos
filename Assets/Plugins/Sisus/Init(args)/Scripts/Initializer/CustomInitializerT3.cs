...
namespace Sisus.Init
{
	...
	public abstract class CustomInitializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument>
		: Initializer<TClient>, IInitializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument>
	{
		...
		protected sealed override void InitTarget(TClient target) => InitTarget(target, firstArgument, secondArgument, thirdArgument);
		...
		{
			AutoInitUtility.PrepareArgumentsForAutoInit<TClient>(this, 3);
