...
namespace Sisus.Init
{
	...
	public abstract class CustomInitializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
		: Initializer<TClient>, IInitializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
	{
		...
		protected override bool HasNullArguments => IsNull(this, firstArgument) || IsNull(this, secondArgument) || IsNull(this, thirdArgument) || IsNull(this, fourthArgument);

		protected sealed override void InitTarget(TClient target) => InitTarget(target, firstArgument, secondArgument, thirdArgument, fourthArgument);
		...
		{
			AutoInitUtility.PrepareArgumentsForAutoInit<TClient>(this, 4);
