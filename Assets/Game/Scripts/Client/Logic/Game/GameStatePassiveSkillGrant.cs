...
{
    public class GameStatePassiveSkillGrant :  StateNode
    {
        ...
        private void SetUpLevelOptions()
        {
            ...
            Service<UIService>.Instance.GetLevelUpPanel().OpenWindowPassives(randomSkills,this);
        ...
        private List<SkillData> GetAvailableSkills()
        {
            ...
            {
                if(skillHandler.GetPassiveSkillLevel(skill.skillId)<skill.maxLevel)
